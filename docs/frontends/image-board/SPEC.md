...
- `server/runtime/<frontend-id>/storage/data/`: uploaded media, ignored by Git except `.gitkeep`
...
- Uploaded images are stored under the active frontend's `server/runtime/<frontend-id>/storage/data/`.
